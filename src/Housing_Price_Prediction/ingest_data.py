"""
This script helps in ingestion of data
from https://raw.githubusercontent.com/ageron/handson-ml/master/
"""
import os
import tarfile
...
def argparse_func():
    """
    This function utilises argparse() method to input arguments to the script.
    ...
    parser.add_argument(
        ...
        help="location of processed dataset.",
    )
...
def ingest(args: Namespace, logger: Logger) -> None:
    """Runs all the above functions and completes the ingestion task.
    ...
    logger.debug("Fetched housing data successfully :)")
    ...
    logger.debug("Preprocessing done successfully :)")

    logger.debug("Saving datasets...")
    os.makedirs(args.processed, exist_ok=True)
    logger.debug("Saved successfully :)")

    logger.debug("Storing preprocessed train dataset...")
    ...
    logger.debug("Storing preprocessed test dataset...")
...
if __name__ == "__main__":
    """Runs only when called directly from the script."""
    args = argparse_func()
